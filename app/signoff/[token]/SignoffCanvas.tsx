...
export function SignoffCanvas({ token, jobLabel }: { token: string; jobLabel: string }) {
  ...
  if (state === "done") {
    return (
      <div className="flex flex-col items-center gap-4 py-12 text-center">
        ...
        <h2 className="text-2xl font-heading uppercase tracking-wide text-white">Signature received</h2>
