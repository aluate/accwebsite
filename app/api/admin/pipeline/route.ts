...
export async function GET() {
  ...
  const jobs = await sql`
      SELECT
        ...
        j.is_placeholder,
        j.placeholder_unit_count,
        j.placeholder_per_unit_value,
        j.placeholder_per_unit_boxes,
        j.placeholder_per_unit_shop_hrs,
        j.placeholder_per_unit_install_hrs,
        j.placeholder_id,
        (SELECT COUNT(*) FROM jobs linked WHERE linked.placeholder_id = j.id) AS placeholder_linked_count,
        e.id                       AS estimate_id,
        ...
        -- FG breakdown for hover tooltip
